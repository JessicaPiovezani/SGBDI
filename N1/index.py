...
while opcao != 0:
    ...
    if opcao == 1:
        ...
        try:
            ...
            categorias = -1
            while categorias != 1:
                categorias = int (input("Para começar, deveremos inserir os dados na tabela de categorias. Se você deseja prosseguir, digite 1.\nPara parar sair do programa digite 0.\nR: "))
                if categorias == 0:
                    break
            ...
            produtos = -1
            while produtos != 1:
                produtos = int (input("Agora iremos realizar a inserção dos produtos. Se você deseja prosseguir, digite 1.\nPara parar sair do programa digite 0.\nR: "))
                if produtos == 0:
                    break
            ...
            cupons = -1
            while cupons != 1:
                cupons = int (input("Por útimo (mas não menos importante), iremos realizar a inserção dos cupons ficais. Se você deseja prosseguir, digite 1.\nPara parar sair do programa digite 0.\nR: "))
                if cupons == 0:
                    break
